...
console.log(`I drive a ${color} ${make} ${model} that was made in ${year}`)
...
let allIngredients = ingredients(nutrients)
...
let harry = new Wizard('Harry', 15, 'Alohomora')
harry.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
class Phone {
  constructor(brand, phonemodel, storage, color, price) {
    this.brand = brand
  ...
  sell() {
    this.sold = true
    console.log(`${this.brand} ${this.phonemodel} has been sold.`)
  }
...
//Code Here
let newPhone = new Phone('Apple', 'iPhone', 64, 'black', 1000)
/* 
...
//Code Here 
let myFirstMotorcycle = new Motorcycle (1, 'red', 10, 'Honda')
/*
...
//Code Here
let myFirstBoat = new Boat (100, 'silver', 20, 'Titanic', 'sea boat')
/*
